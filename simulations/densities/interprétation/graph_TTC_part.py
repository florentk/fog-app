...
data = open('TTC_part.mean','r').readlines()
...
ax.set_ylabel('Part of time with TTC < 3s')
ax.set_xlim(0,5000)
...
ax.legend( (v2v[0],disabled[0],baseline[0]), ("Fog alert V2V","No alert","Baseline"),loc='lower right' )
